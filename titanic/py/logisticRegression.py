""" Random Forest implementation of the Titanic competition
Author : Bruce Tian
...
print 'Predicting...'
output = classifier.predict(test_data).astype(int)


predictions_file = open("../data/logisticRegression.csv", "wb")
